...
const SettingPane = () => {
  return (
    <div><div className="tab-pane" id="pills-setting" role="tabpanel" aria-labelledby="pills-setting-tab">
    {/* Start Settings content */}
    <div>
      <div className="user-profile-img">
        <img src="assets/images/small/img-4.jpg" className="profile-img profile-foreground-img" style={{height: '160px'}} alt="" />
      ...
      <div className="text-center p-3 p-lg-4 border-bottom pt-2 pt-lg-2 mt-n5 position-relative">
        <div className="mb-3 profile-user">
          <img src="" className="rounded-circle avatar-lg img-thumbnail user-profile-image" alt="" />
        ...
        <div className="dropdown d-inline-block">
          ...
          <div className="dropdown-menu">
            <a className="dropdown-item" href=" "><i className="bx bxs-circle text-success fs-10 me-1 align-middle" />
              Active</a>
            <a className="dropdown-item" href=" "><i className="bx bxs-circle text-warning fs-10 me-1 align-middle" />
              Away</a>
            <a className="dropdown-item" href=" "><i className="bx bxs-circle text-danger fs-10 me-1 align-middle" />
              Do not disturb</a>
          </div>
        </div>
      </div>
        ...
        <div id="settingprofile" className="accordion accordion-flush">
          <div className="accordion-item">
            <div className="accordion-header" id="headerpersonalinfo">
              <a className="accordion-button fs-14 fw-medium" data-bs-toggle="collapse" href="#personalinfo" aria-expanded="true" aria-controls="personalinfo">
            ...
            <div id="personalinfo" className="accordion-collapse collapse show" aria-labelledby="headerpersonalinfo" data-bs-parent="#settingprofile">
              <div className="accordion-body edit-input">
                <div className="float-end">
                  <a href=" " className="badge bg-light text-muted" id="user-profile-edit-btn">
                    <i className="bx bxs-pencil align-middle" id="edit-icon" />
                  </a>
                </div>
                <div>
                  <label htmlFor="exampleInputPassword1" className="form-label text-muted fs-13">Name</label>
                  <input type="text" className="form-control" id="exampleInputPassword1" defaultValue="Dushane Daniel" placeholder="Enter name" disabled />
                </div>
                <div>
                  <label htmlFor="exampleInputPassword1" className="form-label text-muted fs-13">Email</label>
                  <input type="email" className="form-control" id="exampleInputPassword1" defaultValue="dashanedaniel@vhato.com" placeholder="Enter email" disabled />
                </div>
                <div className="mt-3">
                  <label htmlFor="exampleInputPassword1" className="form-label text-muted fs-13">Phone No</label>
                  <input type="text" className="form-control" id="exampleInputPassword1" defaultValue="+(245) 4577 14523" placeholder="Enter phone no" disabled />
                </div>
                <div className="mt-3">
                  <label htmlFor="exampleInputPassword1" className="form-label text-muted fs-13">Location</label>
                  <input type="text" className="form-control" id="exampleInputPassword1" defaultValue="California, USA" placeholder="Location" disabled />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="accordion-item">
            <div className="accordion-header" id="privacy1">
              <a className="accordion-button fs-14 fw-medium collapsed" data-bs-toggle="collapse" href="#privacy" aria-expanded="false" aria-controls="privacy">
                <div className="d-flex align-items-center">
                  <div className="flex-shrink-0 me-3 avatar-xs">
                    <div className="avatar-title bg-soft-info text-info rounded">
          ...
          <div className="accordion-item">
            <div className="accordion-header" id="headersecurity">
              <a className="accordion-button fs-14 fw-medium collapsed" data-bs-toggle="collapse" href="#collapsesecurity" aria-expanded="false" aria-controls="collapsesecurity">
                <div className="d-flex align-items-center">
                  <div className="flex-shrink-0 me-3 avatar-xs">
                    <div className="avatar-title bg-soft-info text-info rounded">
            ...
            <div id="collapsesecurity" className="accordion-collapse collapse" aria-labelledby="headersecurity" data-bs-parent="#settingprofile">
              <div className="accordion-body">
          ...
          <div className="accordion-item">
            <div className="accordion-header" id="headerhelp">
              <button className="accordion-button fs-14 fw-medium collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsehelp" aria-expanded="false" aria-controls="collapsehelp">
                <div className="d-flex align-items-center">
                  <div className="flex-shrink-0 me-3 avatar-xs">
                    <div className="avatar-title bg-soft-info text-info rounded">
            ...
            <div id="collapsehelp" className="accordion-collapse collapse" aria-labelledby="headerhelp" data-bs-parent="#settingprofile">
              <div className="accordion-body">
                <ul className="list-unstyled vstack gap-4 mb-0">
                  <li>
